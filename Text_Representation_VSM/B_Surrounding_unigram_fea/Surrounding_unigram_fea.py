...
def Surrounding_unigram_fea(upper_path_pre, upper_path_VSM):									#incoming parameter is the path of preprocess result and the path of VSM result
	print '\n*********************************************************************\n'
	print 'start constructing feature vectors using surrounding unigram as feature term...\n'
